...
namespace msvcbridge{
	...
	FUN_DECLSPEC const ViconDataStreamSDK::CPP::Output_GetDeviceOutputValue GetDeviceOutputValue( const ViconDataStreamSDK::CPP::String & DeviceName,
	                                                      const ViconDataStreamSDK::CPP::String & DeviceOutputName, const ViconDataStreamSDK::CPP::String & DeviceOutputComponentName,const unsigned int & DeviceOutputSubsample ) {
		return client.GetDeviceOutputValue(DeviceName, DeviceOutputName, DeviceOutputComponentName, DeviceOutputSubsample);
	}

	FUN_DECLSPEC const ViconDataStreamSDK::CPP::Output_GetDeviceOutputValue GetDeviceOutputValue( const ViconDataStreamSDK::CPP::String & DeviceName,
	                                                      const ViconDataStreamSDK::CPP::String & DeviceOutputName, const ViconDataStreamSDK::CPP::String & DeviceOutputComponentName) {
		return client.GetDeviceOutputValue(DeviceName, DeviceOutputName, DeviceOutputComponentName);
	}

	FUN_DECLSPEC const ViconDataStreamSDK::CPP::Output_GetForcePlateCount GetForcePlateCount(){
		return client.GetForcePlateCount();
	}

	FUN_DECLSPEC const ViconDataStreamSDK::CPP::Output_GetGlobalForceVector  GetGlobalForceVector( const unsigned int ForcePlateIndex, const unsigned int ForcePlateSubsample ){
		return client.GetGlobalForceVector(ForcePlateIndex);
	}

	FUN_DECLSPEC const ViconDataStreamSDK::CPP::Output_GetGlobalMomentVector GetGlobalMomentVector( const unsigned int ForcePlateIndex, const unsigned int ForcePlateSubsample ){
		return client.GetGlobalMomentVector(ForcePlateIndex);
	}

	FUN_DECLSPEC const ViconDataStreamSDK::CPP::Output_GetGlobalCentreOfPressure  GetGlobalCentreOfPressure( const unsigned int ForcePlateIndex,const unsigned int ForcePlateSubsample ){
		return client.GetGlobalCentreOfPressure(ForcePlateIndex);
	}

	FUN_DECLSPEC const ViconDataStreamSDK::CPP::Output_GetDeviceOutputComponentName GetDeviceOutputComponentName( const ViconDataStreamSDK::CPP::String  & DeviceName,
                                                    const unsigned int   DeviceOutputIndex ){
		return client.GetDeviceOutputComponentName(DeviceName, DeviceOutputIndex);
	}
	FUN_DECLSPEC const ViconDataStreamSDK::CPP::Output_GetDeviceOutputSubsamples GetDeviceOutputSubsamples( const ViconDataStreamSDK::CPP::String & DeviceName,
                                                                const ViconDataStreamSDK::CPP::String & DeviceOutputName, const ViconDataStreamSDK::CPP::String & DeviceOutputComponentName ) {
		return client.GetDeviceOutputSubsamples(DeviceName, DeviceOutputName, DeviceOutputComponentName);
	}
	FUN_DECLSPEC const ViconDataStreamSDK::CPP::Output_GetForcePlateSubsamples GetForcePlateSubsamples( const unsigned int ForcePlateIndex ) {
		return client.GetForcePlateSubsamples(ForcePlateIndex);
	}
